...
Comsión 3, TP5
Valentin Calderon legajo 78575/8
Juani Altamirano, legajo 88233/3
...
void setup() {
  ...
  size(1280, 720);
   ...
   //BOTON
  resetboton = new Boton(1160,680,100,30,"Salir",0,200,200);
...
void keyPressed() { //CONDICIONALES/TECLAS PARA HACER FUNCIONAR EL JUEGO E IR AVANZANDO/RETROCEDIENDO
